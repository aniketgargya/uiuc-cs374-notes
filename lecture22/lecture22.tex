...
\begin{itemize}
    ...
    \item[] \lstinputlisting{code/halting-to-autograder.sudo}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item[] \lstinputlisting{code/L_emptyset-simpleboo.sudo}
