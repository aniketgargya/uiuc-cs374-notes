...
\begin{itemize}
    ...
    \end{center}
    \item[] \lstinputlisting{code/undirected-recursive-dfs.sudo}
...
\begin{itemize}
    ...
    \item[] \lstinputlisting{code/undirected-recursive-dfs-time.sudo}
    \begin{center}
...
\begin{itemize}
    \item[] \lstinputlisting{code/directed-recursive-dfs-time.sudo}
...
\begin{itemize}
    ...
    \item[] \lstinputlisting{code/slow-scc.sudo}
\end{itemize}
...
\begin{itemize}
    ...
    \item[] \lstinputlisting{code/linear-scc.sudo}
\end{itemize}
