...
\usepackage{../lecture}
\lecture{15}{Even More Dynamic Programming, Graphs, and Basic Search}
\date{March 18, 2021}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item[] \lstinputlisting{code/mis-tree.sudo}
...
\begin{itemize}
    ...
    \item[] \lstinputlisting{code/explore.sudo}
    ...
    \item[] \lstinputlisting{code/search-tree-explore.sudo}
